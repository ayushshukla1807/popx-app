  ...
  return (
    <div className="relative w-full mb-4">
      ...
      <div className={`relative w-full border rounded-md px-3 pb-1.5 pt-4 transition-colors focus-within:border-brand ${error ? 'border-red-500' : 'border-gray-300'} bg-white`}>
        ...
        <label 
          htmlFor={id} 
          className={`absolute left-3 top-2 text-xs text-brand font-medium transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-3.5 peer-focus:top-2 peer-focus:text-xs peer-focus:text-brand cursor-text pointer-events-none`}
        >
